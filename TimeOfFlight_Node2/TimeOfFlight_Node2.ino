...
This code will serve to collect and send data from the second Time of Flight sensor, and simulate a busy bus.
This sensor will be just a little lower in priority (determined by CAN ID), but will still be pretty high up there
...
VL53L0X sensor;  
static uint32_t const CAN_ID = 0x11;      // Setting the CAN ID of this node. This is also used for message prioritization, and can be changed as needed
